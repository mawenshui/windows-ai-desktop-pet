...
2026-09-08 核对，适用于 0.14.0 工作区；本轮未增加或替换资产。发行资源来自本目录；`res/` 仅为本地参考，不提交、不打包。
...
商业角色 IP 和未经授权参考不能迁入 assets。未来角色包能力见[后续功能扩展计划](../docs/后续功能扩展计划.md)；3D 与新依赖需先评估，不因文档列出候选就进入安装包。
