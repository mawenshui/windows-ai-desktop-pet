...
当前仓库已有 WPF/.NET 8 产品源码、CC0 RGS 桌宠、页内单选与四页工具窗、自动化测试，以及便携版和 Inno Setup 安装版。0.15.0 在 0.14.0 能力上接入 EXT-11 加密完整 AI 配置包；EXT-07/08 仍只在 tests/prototypes 评估，产品不引用。当前测试与产物见 CURRENT_STATUS.md，真实输入、性能、签名和物理环境仍需独立证据。
