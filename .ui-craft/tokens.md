> 2026-09-08 文档核对：当前基线为 0.14.0，四页是主页、待办、维护、设置，八组选择器已使用页内 ListBox。0.14.0 新增的快捷键与自动备份设置继续复用既有令牌，不引入新颜色、字体或动效。当前实现与验证边界见 [技术设计](../docs/TECHNICAL_DESIGN.md) 和 [当前状态](../docs/CURRENT_STATUS.md)。
